...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    helpembed.setColor("RANDOM")
      ...
      helpembed.setThumbnail("https://cdn.discordapp.com/attachments/833753190859407411/910562424258715738/DisGiveaway-01-01.png")
      ...
      helpembed.setFooter(`© DisGiveaway | Have a nice day!`);
